...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// Weight
			// 
			this->Weight->HeaderText = L"Длина";
			this->Weight->Name = L"Weight";
			// 
			// Letter
			// 
			this->Letter->HeaderText = L"Буква";
			...
			this->primButton->Text = L"Алгоритм Прима";
			...
			this->typeInputGroup->Text = L"Выбор типа ввода данных";
			// 
			...
			this->typeInputRadioButton_1->Text = L"Ввод с помощью матрицы";
			...
			this->typeInputRadioButton_2->Text = L"Ввод с помощью графа";
			...
			this->label2->Text = L"Отображение графа";
			// 
			// label3
			// 
			...
			this->label3->Text = L"Список рёбер";
			// 
			// label4
			// 
			...
			this->label4->Text = L"Количество вершин: ";
			// 
			...
			this->InfoMatrixGridLabel->Text = L"*Матрицу нельзя заполнить вручную( Вводить через \"Список рёбер\")";
			// 
			// stageButton
			// 
			...
			this->stageButton->Text = L"Вперёд";
			...
			this->momentButton->Text = L"Моментально";
			...
			this->typeMSTMoveGroupBox->Text = L"Тип перемещения";
			...
			this->label5->Text = L"Выбранная вершина:";
			// 
			// selectButton
			// 
			...
			this->InfoChoicedVertexLabel->Text = L"*Выбранная вершина - это номер строки выбранной ячейки в матрице смежности";
			// 
			// Form
			// 
